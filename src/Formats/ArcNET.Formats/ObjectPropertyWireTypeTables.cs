...
internal static class ObjectPropertyWireTypeTables
{
    ...
    private static FrozenDictionary<int, ObjectWireType> CreateCommon() =>
        new Dictionary<int, ObjectWireType>
        {
            ...
            [5] = ObjectWireType.Int32Array,
            [6] = ObjectWireType.Int32Array,
            [7] = ObjectWireType.Int32Array,
            ...
            [15] = ObjectWireType.UInt32Array,
            [16] = ObjectWireType.UInt32Array,
            [17] = ObjectWireType.UInt32Array,
    ...
    private static FrozenDictionary<int, ObjectWireType> CreateNpcBits()
    {
        ...
        {
            [128] = ObjectWireType.Int32,
            [129] = ObjectWireType.ObjectId,
            [130] = ObjectWireType.Int32,
            [131] = ObjectWireType.ObjectId,
            [132] = ObjectWireType.ObjectId,
            [133] = ObjectWireType.Int32,
