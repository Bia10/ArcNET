...
public static class ObjectFieldCatalog
{
    ...
    public static string ArrayElementName(int fieldId, int index) =>
        RawName(fieldId) switch
        {
            ...
            "OBJ_F_SCRIPTS_IDX" => RuntimeSemanticCatalog.AttachmentPointName(index),
            "OBJ_F_CRITTER_STAT_BASE_IDX" => RuntimeSemanticCatalog.StatName(index),
    ...
    private static string SpellTechSlotName(int index)
    {
