...
public sealed class SheetService(ISheetBackend backend)
{
    ...
    public static SheetService Default { get; } = new(new SheetBackend());
    ...
    private static IReadOnlyList<ReadValueSnapshot> CreateSheetValues(
        ...
        reference.Route switch
        {
            ...
            SheetRoute.Resistance => CreateScalarValues(data.Resistances, reference.Id, "Resistance Id", "Resistance"),
            SheetRoute.SpellCollege => CreateScalarValues(data.SpellColleges, reference.Id, "College Id", "College"),
